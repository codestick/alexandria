    ...
    describe 'GET /api/books' do
        ...
        describe 'field_picking' do
            ...
            context 'with invalid field name "fid"' do
                ...
                it 'receives "fields=fid" as an invalid params' do
                    expect(json_body['error']['invalid_params']).to eq 'field=fid'
                end
            end
        end
        ...
        describe 'GET /api/books/:id' do
            context 'with existing resource' do
                ...
                it 'receives the "rails_tutorial" book as JSON' do
                    expected = { data: BookPresenter.new(rails_tutorial, {}).fields.embed }
        ...
        describe 'embed picking' do
            context "with the 'embed' parameter" do
                ...
                it 'gets the book with their authors embedded' do
                    json_body['data'].each do |book|
            ...
            context 'with invalid "embed" relation "fake"' do
                ...
                it 'receives "fields=fid" as an invalid_param' do
                    expect(json_body['error']['invalid_params']).to eq 'embed_fake'
                end
            end
        ...
        describe 'filtering' do
            ...
            context 'with invalid filtering param "q[ftitle_cont]=Microscope"' do
                ...
                it 'receives "q[ftitle_cont]=Ruby" as invalid param ' do
